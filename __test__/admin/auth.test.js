...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Ava38',
      password: 'dOMB83TpRod0lHL',
      email: 'Devante_Satterfield@hotmail.com',
      name: 'Doreen Gutkowski',
      userType: 563,
      mobileNo: '(911) 040-9725',
      resetPasswordLink: {},
      loginRetryLimit: 742,
      loginReactiveTime: '2023-02-15T02:01:35.384Z',
      id: '62d47c3f914e2197ddcb6ced'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Shyann74',
        'password':'qimNkWX12tw5A9c',
        'email':'Lilly27@gmail.com',
        'name':'Sadie Kutch',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(707) 081-4278',
